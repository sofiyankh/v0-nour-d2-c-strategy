  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1">
        {/* Hero Section */}
        <section className="relative h-96 bg-gradient-to-r from-secondary to-secondary/70 text-white overflow-hidden">
          <div className="absolute inset-0 opacity-20">
            <div className="absolute top-0 left-0 w-96 h-96 bg-white rounded-full -ml-48 -mt-48"></div>
          </div>
          <div className="relative h-full flex items-center justify-center text-center px-4">
            <div className="max-w-2xl">
              <h1 className="text-5xl font-bold mb-4">منتجات المكياج</h1>
              <p className="text-xl text-white/90">
                Enhance your beauty with our expertly crafted makeup collection
              </p>
            </div>
          </div>
        </section>
